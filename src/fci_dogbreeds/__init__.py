"""FCI Dog Breeds Extractor

A Python package to extract FCI (Fédération Cynologique Internationale) 
registered dog breeds data in multiple languages using the Gemini API.

This package provides functionality to:
- Query the Gemini API for dog breed information
- Generate JSON and CSV files for multiple languages
- Support 1Password integration for API key management
"""
import logging
import os
import sys
